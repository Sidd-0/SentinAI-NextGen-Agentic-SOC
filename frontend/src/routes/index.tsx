...
import { signInRemote, signUpRemote, resetAccessCodeRemote, passwordStrength } from "@/lib/sentinai-store";
...
function GatewayPage() {
  ...
  function handleReset(e: React.FormEvent) {
    ...
    (async () => {
      const r = await resetAccessCodeRemote(resetEmail);
      setSubmitting(false);
      if (!r.ok) {
        setError(r.error || "Reset failed.");
        return;
      }
      setNotice(r.notice || "Neural reset link dispatched to your department inbox.");
    })();
  }
